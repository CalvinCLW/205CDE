...
<!-- Banner -->
<img src="img/banner/privacyandpolicy.jpg" class="banner"> 
<!-- End of Banner -->
        ...
        <div class="box">
            <div class="col-md-12">
                    <h1>Privacy policy</h1>
                        ...
                        <h2>Contacting us</h2>
                        <p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may do so via the <a target="_blank" rel="nofollow" href="http://localhost/assignment/contactus.php">contact form</a> or send an email to askus@roastarycafe.com</p>
                </div>
            </div>								
        </div>
    </div>
